...
- **node-router archived**: `orchestrator_client.py` and `fleet_agent.py` (coms-net dispatch) archived to `Efforts/Infrastructure/fleet-orchestration/node-router/`. Scoring, routing, and benchmarking migrated to fleet-resource-manager.
